...
import it.umy.datamahasiswa.exceptions.NonexistentEntityException;
import it.umy.datamahasiswa.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("it.umy_datamahasiswa_jar_0.0.1-SNAPSHOTPU");
